import { b as createLucideIcon, r as reactExports, j as jsxRuntimeExports, B as Button, c as cn, S as Skeleton, C as ChevronRight } from "./index-k3Dj9kgV.js";
import { I as Input, u as ue, A as AlertDialog, a as AlertDialogTrigger, T as Trash2, b as AlertDialogContent, c as AlertDialogHeader, d as AlertDialogTitle, e as AlertDialogDescription, f as AlertDialogFooter, g as AlertDialogCancel, h as AlertDialogAction, C as ChevronDown } from "./index-Du1oRWt-.js";
import { u as useWatchlist, e as useAddToWatchlist, h as applyExchangeSuffix, c as useRefreshPrice, i as useRemoveFromWatchlist, d as deriveCurrency, j as PriceInline, k as useStockSignal, l as formatPrice } from "./useBackend-CAnAfp9Y.js";
import { S as Signal, a as SignalBadge } from "./SignalBadge-wa7EAhHq.js";
import { R as RefreshCw, P as Plus } from "./refresh-cw-oOsi79T4.js";
/**
...
function IndicatorCell({
  ...
  const colorCls = highlight === "up" ? "text-primary" : highlight === "down" ? "text-destructive" : "text-foreground";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5 min-w-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "data-label text-[10px]", children: label }),
    ...
    sub && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] text-muted-foreground tabular-nums", children: sub })
  ] });
}
function IndicatorGrid({
  ...
  const rsiH = rsi <= 30 ? "up" : rsi >= 70 ? "down" : "neutral";
  const emaH = emaShort > emaLong ? "up" : emaShort < emaLong ? "down" : "neutral";
  const macdH = macdHistogram > 0 ? "up" : macdHistogram < 0 ? "down" : "neutral";
  const fmtPrice = (v) => v.toLocaleString(locale, {
    minimumFractionDigits: 2,
    maximumFractionDigits: 2
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 pt-3 border-t border-border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "data-label mb-3", children: "Technical Indicators" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 sm:grid-cols-5 gap-x-6 gap-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        IndicatorCell,
        {
          label: "RSI (14)",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "data-label text-[10px]", children: "MACD" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: cn(
              "font-mono text-sm tabular-nums font-medium",
              macdH === "up" ? "text-primary" : macdH === "down" ? "text-destructive" : "text-foreground"
            ),
            children: formatPrice(macdLine, 4)
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-[10px] text-muted-foreground tabular-nums", children: [
          "sig ",
          formatPrice(macdSignal, 4)
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "span",
          {
            className: cn(
              ...
              macdH === "up" ? "text-primary" : macdH === "down" ? "text-destructive" : "text-muted-foreground"
            ),
            children: [
              "hist ",
              macdHistogram > 0 ? "+" : "",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "data-label text-[10px]", children: "Bollinger Bands" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-sm tabular-nums font-medium text-foreground", children: [
          sym,
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 sm:grid-cols-5 gap-4 pt-1", children: ["s1", "s2", "s3", "s4", "s5"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 rounded-sm" }, k)) })
        ]
      }
    );
  }
  if (isError || !signal) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          "Signal data unavailable for ",
          symbol,
          ". Try refreshing the price."
        ]
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(IndicatorGrid, { indicators: signal.indicators, currency });
}
function StockRow({
  item,
  index,
  ...
  const derivedSignal = item.changePercent >= 2 ? Signal.Buy : item.changePercent <= -2 ? Signal.Sell : Signal.Hold;
  function handleRefresh(e) {
    e.stopPropagation();
    refreshPrice.mutate(item.symbol, {
      onSuccess: () => ue.success(`${item.symbol} price refreshed`),
      onError: () => ue.error(`Failed to refresh ${item.symbol}`)
    });
  }
  function handleRemove() {
    removeFromWatchlist.mutate(item.symbol, {
      onSuccess: () => ue.success(`${item.symbol} removed from watchlist`),
      onError: () => ue.error(`Failed to remove ${item.symbol}`)
    });
  }
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-24 flex-shrink-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground text-sm tracking-wide leading-none", children: item.symbol }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground uppercase tracking-widest mt-0.5", children: item.exchange ?? "Equity" })
              ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden sm:block w-20 text-right flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  className: cn(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-[72px] flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SignalBadge, { signal: derivedSignal, size: "sm" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden sm:block flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "svg",
                {
                  viewBox: "0 0 60 20",
                  className: "w-14 h-5",
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "polyline",
                    {
                      points: isUp ? "0,16 15,13 30,9 45,6 60,3" : "0,3 15,6 30,11 45,14 60,17",
                      fill: "none",
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { children: [
                                ...
                                " ",
                                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-semibold text-foreground", children: item.symbol }),
                                ". You can re-add it at any time."
                              ] })
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { "data-ocid": `${base}.delete_cancel_button`, children: "Cancel" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                AlertDialogAction,
                                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 text-muted-foreground w-4", children: isExpanded ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-4 h-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-4 h-4" }) })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { initial: false, children: isExpanded && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-4", "data-ocid": `${base}.indicators_panel`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ExpandedIndicators, { symbol: item.symbol, currency }) })
          },
          "indicators"
        ) })
      ]
...
function WatchlistSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", "data-ocid": "watchlist.loading_state", children: ["s1", "s2", "s3", "s4", "s5"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "trading-card px-4 py-3 flex items-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-24 flex-shrink-0 space-y-1", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-14 hidden sm:block" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-14 rounded-sm" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-14 hidden sm:block" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-7 w-7 rounded-sm" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-7 w-7 rounded-sm" }),
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-7 h-7 text-muted-foreground" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-foreground text-base", children: "Your watchlist is empty" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm max-w-xs leading-relaxed", children: "Add NSE/BSE stocks (e.g. INFY, TCS) or US symbols to track live prices and BUY / HOLD / SELL signals with technical analysis." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
...
function Watchlist() {
  ...
  function handleAdd(e) {
    ...
    if (watchlist.some((w) => w.symbol === sym)) {
      ue.warning(`${sym} is already on your watchlist`);
      return;
    }
    addToWatchlist.mutate(
      ...
      {
        onSuccess: () => {
          ue.success(`${sym} added to watchlist`);
          setTicker("");
        },
        onError: () => ue.error(`Failed to add ${sym}. Check the symbol and try again.`)
      }
    );
  }
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4 flex-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-xl text-foreground tracking-tight", children: "Watchlist" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-0.5", children: "Track NSE, BSE & US stocks — live prices and trade signals" })
          ] }),
          watchlist.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 signal-buy text-[11px] font-mono font-semibold px-2 py-0.5 rounded-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-primary" }),
              buyCount,
              " BUY"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 signal-hold text-[11px] font-mono font-semibold px-2 py-0.5 rounded-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-accent" }),
              holdCount,
              " HOLD"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 signal-sell text-[11px] font-mono font-semibold px-2 py-0.5 rounded-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "form",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative flex-1 min-w-[140px] max-w-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  ref: inputRef,
                  value: ticker,
                  onChange: (e) => setTicker(e.target.value.toUpperCase()),
                  placeholder: exchange === "NSE" ? "e.g. INFY (.NS auto-added)" : exchange === "BSE" ? "e.g. INFY (.BO auto-added)" : "e.g. AAPL",
                  maxLength: 12,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  ...
                  children: [
                    addToWatchlist.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "w-4 h-4 mr-1.5 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-4 h-4 mr-1.5" }),
                    "Add"
                  ]
                }
              ),
              addToWatchlist.isError && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
        ...
        !isLoading && watchlist.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-4 border-b border-border pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-24 flex-shrink-0 data-label text-[10px]", children: "SYMBOL" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 data-label text-[10px]", children: "PRICE" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:block w-20 text-right data-label text-[10px]", children: "24H CHG" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-[72px] text-right data-label text-[10px]", children: "SIGNAL" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:block w-14 data-label text-[10px]", children: "TREND" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-16 data-label text-[10px]", children: "ACTIONS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-4" })
        ] }),
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(WatchlistSkeleton, {}) : watchlist.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { onFocusInput: () => {
          var _a;
          return (_a = inputRef.current) == null ? void 0 : _a.focus();
        } }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", "data-ocid": "watchlist.list", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "popLayout", children: watchlist.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          StockRow,
          {
            item,
            index: i + 1,
